...
export const ANNOUNCE_CARD_DESCRIPTION =
  "Send spoken announcements to Ted's Dashboard devices/areas (requires the Ted's Dashboard System integration).";

export const ANNOUNCEMENTS_SENSOR = "sensor.teds_announcements";
export const ANNOUNCE_DOMAIN = "teds_dashboard_system";
