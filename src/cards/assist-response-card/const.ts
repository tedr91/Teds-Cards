...
export const ASSIST_RESPONSE_CARD_DESCRIPTION =
  "Displays a title + message pushed by a voice intent or automation (requires the Ted's Cards Backend integration).";

export const ASSIST_RESPONSE_DOMAIN = "teds_cards_backend";
