...
export type ButtonSize = "half" | "normal" | "1.5x" | "2x" | "3x" | "4x" | "full";
...
export interface RoomButtonSizing {
  /** Width footprint: half / normal / 1.5x / 2x / 3x / 4x / full. Defaults to "normal". */
  ted_button_width?: ButtonSize;
  /** Height footprint: half / normal / 1.5x / 2x / 3x / 4x / full. Defaults to "normal". */
...
export interface RoomCardConfig extends LovelaceCardConfig {
  ...
  /** Horizontal alignment of the header (name/icon) within the status strip. Defaults to "left". */
  header_h_align?: "left" | "center" | "right";
