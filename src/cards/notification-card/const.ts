...
export const NOTIFICATION_CARD_DESCRIPTION =
  "A notification center: a bell with an unread badge that opens a list of notifications (requires the Ted's Dashboard System integration).";

export const NOTIFICATIONS_SENSOR = "sensor.teds_notifications";
export const NOTIFICATION_DOMAIN = "teds_dashboard_system";
