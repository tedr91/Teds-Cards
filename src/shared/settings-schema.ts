...
export const SETTINGS_FIELDS: SettingField[] = [
  ...
  { key: "notification_sound_info", label: "Info sound", group: "Notifications", kind: "media", help: "\"default\" uses the fallback above." },
  { key: "notification_sound_success", label: "Success sound", group: "Notifications", kind: "media", help: "\"default\" uses the fallback above." },
  { key: "notification_sound_warning", label: "Warning sound", group: "Notifications", kind: "media", help: "\"default\" uses the fallback above." },
  { key: "notification_sound_danger", label: "Danger sound", group: "Notifications", kind: "media", help: "\"default\" uses the fallback above." },
